...
public class Solution {
    ...
    public static boolean compareMD5(ByteArrayOutputStream byteArrayOutputStream, String md5) throws Exception {
        ...
        //String res = new BigInteger(1, md.digest()).toString(16); // в этом случае будет необходимо добивать строку нулями, если она меньше 32 символов
        String res = DatatypeConverter.printHexBinary(md.digest()).toLowerCase();
        return MessageDigest.isEqual(md5.getBytes(), res.getBytes());
    }
}
