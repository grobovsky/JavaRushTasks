    ...
    public static class Human {
        ...
        public void save(OutputStream outputStream) throws Exception {
            ...
            if (this.assets.size() > 0) {
                for (Asset current : this.assets) {
                    ...
                    printWriter.println(current.getPrice()); //все поля Asset учитываем
                }
            }
            printWriter.close();
        }
        ...
        public void load(InputStream inputStream) throws Exception {
            ...
            while ((assetName = reader.readLine()) != null) {
                ...
                a.setPrice(Double.valueOf(reader.readLine())); //все поля Asset учитываем
                this.assets.add(a);
            }
            reader.close();
        }
        ...
        public boolean equals(Object o) {
            ...
            if (name != null ? !name.equals(human.name) : human.name != null) return false; //name == null
