...
public class Solution {
     ...
     * @author JavaRush
     */
    public static class OutputToConsole implements Externalizable { //ну тут понятно
        private int counter;
        ...
        public void writeExternal(ObjectOutput out) throws IOException {
            ...
            out.flush(); //без flush выбросит EOFException
        }
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        Solution.OutputToConsole test = new Solution.OutputToConsole(5);
        ByteArrayOutputStream ba = new ByteArrayOutputStream();
        ObjectOutput out = new ObjectOutputStream(ba);
        test.writeExternal(out);
        byte[] dst = ba.toByteArray();

        ObjectInput in = new ObjectInputStream(new ByteArrayInputStream(dst));
