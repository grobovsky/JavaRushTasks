...
public class Solution {
    public static void main(String[] args) {
        ...
        try {
            ...
            if (ivanov.equals(somePerson)){
                System.out.println("All right, its ivanov");
            } else {
                System.out.println("Oops, its not ivanov");
            }
    ...
    public static class Human {
        ...
        public void load(InputStream inputStream) throws IOException {
            ...
            name = in.readLine();
            while (in.ready()){
                String assetName = in.readLine();
                Double assetDouble = Double.parseDouble(in.readLine());
                assets.add(new Asset(assetName, assetDouble));
            }
        }
    }
}
